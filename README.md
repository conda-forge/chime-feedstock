...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chime-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14953&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chime-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chime` can be installed with:

```
conda install chime
```

It is possible to list all of the versions of `chime` available on your platform with:
